            ...
            <div class="d-grid col-lg-4 col-md-6 mb-5 ">
                ...
                <div class="card border-0 shadow rounded tour-item "
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <button type="button" href="#" class="btn btn-primary w-100 mt-3"
                            id="<?php echo $row['sr_no'] ?>"><a href="detail_tours.php?id=<?php echo $row['sr_no'] ?>"
                                style="text-decoration: none; color: #fff;">Booking now</a></button>
                    </div>
                </div>
